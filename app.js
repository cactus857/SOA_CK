...
const limiter = rateLimit({
    ...
    skip: (req, res) => req.ip === '::1' || req.ip === '127.0.0.1'
});
app.use('/api', limiter);

// Stripe webhook, BEFORE express.json(), because stripe needs the body as stream
app.post(
    '/webhook-checkout',
...
// XSS protection built-in with helmet
// (xss-clean is deprecated, helmet provides sufficient XSX protection)
